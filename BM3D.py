...
if __name__ == '__main__':
    cv2.setUseOptimized(True)   # OpenCV cv2.setUseOptimized() 。
    img_name = "C:/Users/CASS/BM3D-Denoise/BM3D_test_images/dat5ser003img00001 (128).png"  
    img = cv2.imread(img_name, cv2.IMREAD_GRAYSCALE)    # cv2.IMREAD_GRAYSCALE
    ...
    cv2.imwrite("Basic_img.jpg", Basic_img)
